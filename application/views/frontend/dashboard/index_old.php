...
<div class="row-fluid">
	<div class="container">
		<span class="help-block"><i>* are searchable fields.</i></span>
		<div class="row">
			<form action="" method="post" id="CustomerForm">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" name="address1" class="form-control customer_address" placeholder="Address">
									<input type="hidden" name="address_id" class="form-control address_id" value="">
								</div>
							</div>
						</div>
						<!--/span-->
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="text" name="state" class="form-control customer_state" placeholder="State">
								</div>
							</div>
						</div>
						<!--/span-->
						...
						<div class="col-md-12 text-left">
							<div class="form-group">
								<label class="control-label col-md-2">
									<a href="#CustomerComments" data-backdrop="static" data-keyboard="false" data-toggle="modal" class="btn btn-info customer_comments disabled">Comments</a>
								</label>
								<div class="col-md-10">
				...
				<div class="row">
					...
					<a href="#POProcess" data-backdrop="static" data-keyboard="false" data-toggle="modal" class="btn btn-info po_history_btn disabled">PO History</a>
					<a href="#SOProcess" data-backdrop="static" data-keyboard="false" data-toggle="modal" class="btn btn-info so_history_btn disabled">SO History</a>
					
					<a href="#LogCall" data-backdrop="static" data-keyboard="false" data-toggle="modal" class="btn btn-info log_call disabled">Log Call</a>
					...
					<a href="javscript:void(0);" class="btn btn-info disabled" onclick="update_customer();">Update</a>
				</div>
				</div>
			</form>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-1 pull-right">
							<!-- <button class="btn btn-info product-save-btn pull-right">Save</button> -->
						</div>
					</div>
				</div>
				</div>
