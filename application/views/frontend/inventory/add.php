            ...
            <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#tab2primary" class="tablinks" data-toggle="tab">Category</a></li>
                            <li><a href="#tab3primary" class="tablinks" data-toggle="tab">Inventory Images</a></li>
                        </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active tabcontent" id="tab1primary">
                            <div class="form-grid col-md-6">
                                ...
                                <div class="form-group col-md-4 <?php echo (form_error('category_id'))?'error':'';?>" data-error="<?php echo (form_error('category_id'))? form_error('category_id'):'';?>">
