 <div class="row">
  ...
  <form name="inventorypackage" method="POST">
      ...
      <div class="form-grid col-md-6">
        ...
        <div class="form-group  <?php echo (form_error('name'))?'error':'';?>" data-error="<?php echo (form_error('name'))? form_error('name'):'';?>">
          ...
          <input type="text" name="name" class="form-control" id="name" value="<?php echo set_value('name', $editdata['name']);?>" placeholder="Package Name" />
        </div>
        ...
        <div class="form-group col-md-2 col-md-offset-8">   
          <a href="<?php echo site_url('inventorytype');?>" class="btn btn-block active text-center">Back</a>
        </div>
