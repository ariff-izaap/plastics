					...
					if($so_order){
						foreach ($so_order as $skey => $svalue)
						{
							...
							<tr>
                                ...
                                <td class="text-center"><?=$svalue['id'];?></td>
								<td class="text-center"><?=$svalue['business_name'];?></td>
                                <td class="text-center"><?=$svalue['pname'];?></td>
                                <td class="text-center"><?=$svalue['type'];?></td>
                                <td class="text-center"><?=$svalue['total_items'];?></td>
                                <td class="text-center"><?=$svalue['ship_company'];?></td>
								<td class="text-center"><?=$svalue['first_name'];?></td>
								<td class="text-center"><?=$svalue['total_amount'];?></td>
								<td class="text-center"><?=$svalue['flat_rate'];?></td>
