<thead>
	<th>Product</th><th>SKU</th><th>Unit Price</th><th>Quantity</th><th>Total</th><th width="180">Action</th>
</thead>
<tbody>
	<?php
		if($cart)
			...
			foreach ($cart as $key => $value)
			{
				...
				?>
					<tr>
						...
						<td>
							<input type="number" name="qty" max="10" min="1" value="<?=$value['qty'];?>" class="qty_<?=$rand;?>">
						</td>
