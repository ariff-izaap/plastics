...
class Salesproductselection extends Admin_Controller 
{
    ...
    function __construct()
    {
     ...
     {         
        ...
        $str = '<button type="button" id="addcart{id}" name="add_to_cart" onclick="product_add_to_shipment({id})" data-price="{wholesale_price}" data-qty="{quantity}" class="btn">Add To Cart</button>';
